...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  dakshExtensions = {
    ...
    version = "a8bd25b121b2943a2e90e026f697cf97a725d5d7";
    src = fetchgit {
      url = "https://github.com/daksh2k/Spicetify-stuff";
      rev = "a8bd25b121b2943a2e90e026f697cf97a725d5d7";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-6SG/I4UWNolTiXXJ3ErK5I3avBqyYmIvHKS7UuOoLT8=";
    };
  };
  defaultDynamicSrc = {
    pname = "defaultDynamicSrc";
    version = "af191ad6e89a1ce767581842410e821baf4c39c3";
    src = fetchgit {
      url = "https://github.com/JulienMaille/spicetify-dynamic-theme";
      rev = "af191ad6e89a1ce767581842410e821baf4c39c3";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-J2UXOYOGdslxxl9SqNdmwCKuFyLAePwJYa9DqA6u+Ug=";
    };
  };
  draculaSrc = {
    pname = "draculaSrc";
  ...
  marketplaceSrc = {
    ...
    version = "bbbac808be49720230096d1f7174a975408bd39b";
    src = fetchgit {
      url = "https://github.com/spicetify/spicetify-marketplace";
      rev = "bbbac808be49720230096d1f7174a975408bd39b";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Glih+x0xzQy5AO/md2d6mwRKj2dD3YbbBL/xEReZptQ=";
    };
  };
  nameThatTuneSrc = {
